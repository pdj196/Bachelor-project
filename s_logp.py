...
for run in range (runs):
  ...
  population = spa.kekulize_list(np.random.choice(smiles_list, population_size))
  scores = spa.calculate_score(population)
  ...
  for generation in range(generations):
    ...
    new_scores = spa.calculate_score(new_population)
